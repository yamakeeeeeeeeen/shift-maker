...
describe("readCsv", () => {
  describe("readCompatibilityCsv", () => {
    ...
    describe("異常系", () => {
      it("存在しないファイルパスを指定した場合、エラーを出力すること", async () => {
        await expect(
          readCompatibilityCsv("./test/csv/compatibility.cs"),
        ).rejects.toThrow(
          "ファイルが見つかりません: ./test/csv/compatibility.cs",
        );
      });
    });
  });
  ...
  describe("readCustomerCsv", () => {
    ...
    describe("異常系", () => {
      it("存在しないファイルパスを指定した場合、エラーを出力すること", async () => {
        await expect(readCustomerCsv("./test/csv/customer.cs")).rejects.toThrow(
          "ファイルが見つかりません: ./test/csv/customer.cs",
        );
      });
    });
  });
  ...
  describe("readCustomerScheduleCsv", () => {
    ...
    describe("異常系", () => {
      it("存在しないファイルパスを指定した場合、エラーを出力すること", async () => {
        await expect(
          readCustomerScheduleCsv("./test/csv/customer_schedule.cs"),
        ).rejects.toThrow(
          "ファイルが見つかりません: ./test/csv/customer_schedule.cs",
        );
      });
    });
  });
  ...
  describe("readEmployeeCsv", () => {
    ...
    describe("異常系", () => {
      it("存在しないファイルパスを指定した場合、エラーを出力すること", async () => {
        await expect(readEmployeeCsv("./test/csv/employee.cs")).rejects.toThrow(
          "ファイルが見つかりません: ./test/csv/employee.cs",
        );
      });
    });
  });
